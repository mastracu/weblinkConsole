                ...
                if (not (channelName="v1.raw.zebra.com") && (msglen < 1024) ) then
                    ...
                    | Some jsonval ->
                        ...
                        | "v1.config.zebra.com" ->
                             ...
                             do printersAgent.SendMsgOverConfigChannel printerUniqueId (Opcode.Binary, UTF8.bytes """{}{"alerts.add":"ALL MESSAGES,SDK,Y,Y,WEBLINK.IP.CONN2,0,N,"} """, true) true
                             do printersAgent.SendMsgOverConfigChannel printerUniqueId (Opcode.Binary, UTF8.bytes """{}{"alerts.add":"SGD SET,SDK,Y,Y,WEBLINK.IP.CONN2,0,N,capture.channel1.data.raw"} """, true) true
