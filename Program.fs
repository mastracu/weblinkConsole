                ...
                if (not (channelName="v1.raw.zebra.com") && (msglen < 1024) ) then
                    ...
                    | Some jsonval ->
                        ...
                        | "v1.config.zebra.com" ->
                             ...
                             do printersAgent.SendMsgOverConfigChannel printerUniqueId (Opcode.Binary, UTF8.bytes """{}{"alerts.configured":"ALL MESSAGES,SDK,Y,Y,WEBLINK.IP.CONN1,0,N,|ALL MESSAGES,SDK,Y,Y,WEBLINK.IP.CONN2,0,N,|SGD SET,SDK,Y,Y,WEBLINK.IP.CONN1,0,N,capture.channel1.data.raw"} """, true) true
